...
public class InshoreIceReportFileNotReadMailTest {
    ...
    public void test() {
        ...
        // VERIFY
        String header = "PolarWeb was not able to parse and import inshore ice report with name " + inshoreIceReport;
        String body = "PolarWeb was not able to parse import the inshore ice report " + inshoreIceReport + " due to unexpected error during file read: " + cause.getMessage() + "\n";
        body += "Please make sure the file format is as required by PolarWeb.\n";
