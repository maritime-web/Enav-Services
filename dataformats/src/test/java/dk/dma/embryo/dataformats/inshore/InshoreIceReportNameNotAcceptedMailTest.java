...
public class InshoreIceReportNameNotAcceptedMailTest {
    ...
    public void test(){
        ...
        // VERIFY
        String header = "PolarWeb was not able to import inshore ice report with inconsistent name " + inshoreIceReport;
        String body = "PolarWeb was not able to import the inshore ice report " + inshoreIceReport + ", because it does not follow the expected naming scheme.\n";
