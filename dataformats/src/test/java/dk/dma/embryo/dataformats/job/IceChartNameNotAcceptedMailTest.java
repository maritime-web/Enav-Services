...
public class IceChartNameNotAcceptedMailTest {
    ...
    public void test(){
        ...
        // VERIFY
        String header = "PolarWeb was not able to import ice chart with inconsistent name " + iceChart;
        String body = "PolarWeb was not able to import the ice chart " + iceChart + ", because it does not follow the expected naming scheme.\n";
